...
<?php if( $layout != 'cover' ) { ?>
				<div class="bs-timestamp">
					<img src="https://platform.dreamlife.co/wp-content/uploads/Date_Icon.png">
			...
			<div class="topic-counts">
				<img src="https://platform.dreamlife.co/wp-content/uploads/Post_Icon.png">
				<?php $value = bbp_get_forum_post_count(); echo $value . " Posts"; ?>
			</div>
			<div class="bb-forum-content-wrap">
				...
				<a href="<?php bbp_forum_permalink(); ?>" class="custom_btn forums-bg_black_btn">Learn More</a>
			</div>
