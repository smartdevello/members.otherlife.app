...
?>
					<div class="custom-prev-next learndash_next_prev_link">
                        			<?php
                                    if ( $pagination_urls['prev'] != '' ) {
                                        echo $pagination_urls['prev'];
                                    } else {
                        			...
                        			<?php if ( $pagination_urls['next'] != '') {
                                        ...
                                        echo '<span class="next-link empty-post">Next</span>';
                                    }
                                    ?>
                        		</div>
					<?php
...
<div class="course_footer container-fluid">
	<?php include locate_template('/template-parts/footer-course.php'); ?>
</div>